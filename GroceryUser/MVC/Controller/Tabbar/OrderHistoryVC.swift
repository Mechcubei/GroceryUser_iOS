...
class OrderHistoryVC: UIViewController {
    ...
    var selectedIndex = 0
    var arrNameCategories = ["ALL ORDERS","COMPLETED","CANCEL"]
    ...
    lazy var aboutSelfPVC: PageViewController = {
        ...
        viewController.pages = {
            return [
                getViewController(withIdentifier: "OrderTypeVC"),
                getViewController(withIdentifier: "OrderTypeVC"),
                getViewController(withIdentifier: "OrderTypeVC")
            ]
        }()
...
extension OrderHistoryVC: UICollectionViewDelegate,UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return CGSize(width: collectnView.frame.size.width/3, height: collectnView.frame.size.height)
    }
